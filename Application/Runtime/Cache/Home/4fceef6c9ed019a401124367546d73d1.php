...
<form action="/stockbbs/index.php/Tie/parper?title=<?php echo ($title); ?>" method="post">
    <header class="major"style="margin-left:50px">
        ...
        <br>
        <h3><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>访问次数：<?php echo ($list["cishu"]); ?></h3>
        <br>
        <h3><span class="glyphicon glyphicon-time" aria-hidden="true"></span>发帖时间：<?php echo ($list["time"]); ?></h3>
        <br>
