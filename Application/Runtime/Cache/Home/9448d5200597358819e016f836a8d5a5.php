...
<br>
<br>
<form action="/stockbbs/index.php/Lunwen/uploadLunwen1" enctype="multipart/form-data" method="post" >
    <input type="file" name="file"class="form-control"  style="margin-left:100px;width:200px">
    <br>
    <input type="text" name="title" class="form-control" style="margin-left:100px;width:500px" placeholder="请输入标题">
    <br>
    <input type="text" name="key" class="form-control" style="margin-left:100px;width:500px" placeholder="请输入关键字">
    <br>
    <input type="text" name="miaoshu"class="form-control" style="margin-left:100px;width:800px" placeholder="请输入描述">
    <br>
    <input type="text" name="grade"class="form-control" style="margin-left:100px;width:200px" placeholder="请输入积分">
    <br>
