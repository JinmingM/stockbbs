...
<head>
    ...
    <script>
        function download(val1,val2)
        {
            if (confirm("下载需要"+val2+"积分下载此文件吗？")){
                location.href="/stockbbs/index.php/Lunwen/download1?title="+val1;
                return true;
            }else{
                return false;
            }
    ...
    <ul class="nav nav-pills nav-justified navbar-static-top">
        ...
        <li role="presentation" class="active"><a href="/stockbbs/index.php/Lunwen/uploadLunwen"><strong>共享信息上传</strong></a></li>
        <li role="presentation" class="active"><a href="/stockbbs/index.php/Lunwen/download"><strong>浏览共享信息</strong></a></li>
...
<div class="register-box-body">
    <form action="/stockbbs/index.php/Lunwen/findLunwen" method="post">
...
<table class="table table-hover" >
    <tr><td><h4>          </h4></td><td><h4>用户名</h4></td><td><h4>论文标题</h4></td><td><h4>关键字</h4></td><td><h4>需要积分</h4></td><td><h4>下载</h4></td><td><h4>时间</h4></td><td><h4>操作</h4></td></tr>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--<tr><td><h4>ID</h4></td><td><h4>用户名</h4></td><td><h4>积分</h4></td><td><h4>注册时间</h4></td><td><h4>操作</h4></td></tr>-->
        <?php if($vo["uname"] != null ): ?><td>
                ...
                </div></td><td><h4><span class="glyphicon glyphicon-user" aria-hidden="true"></span><?php echo ($vo["uname"]); ?></h4></td><td><h4><a href='/stockbbs/index.php/Lunwen/parper/title/<?php echo ($vo["title"]); ?>'><?php echo ($vo["title"]); ?></a></h4></td><td><h4><?php echo ($vo["key"]); ?></h4></td><td><h4><?php echo ($vo["grade"]); ?></h4></td><td><h4><?php echo ($vo["cishu"]); ?></h4></td><td><h4><?php echo ($vo["time"]); ?></a></h4></td><td><h4><input type="button" value="点击下载" onclick="download('<?php echo ($vo["title"]); ?>','<?php echo ($vo["grade"]); ?>')"/></a></h4></td></tr><?php endif; endforeach; endif; else: echo "" ;endif; ?>
</table>
